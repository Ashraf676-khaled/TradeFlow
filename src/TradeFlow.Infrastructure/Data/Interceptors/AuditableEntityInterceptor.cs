...
public class AuditableEntityInterceptor(ICurrentUserService currentUser, TimeProvider dateTime)
  ...
  public void UpdateEntities(DbContext? context)
  {
    ...
    foreach (var entry in context.ChangeTracker.Entries<IAuditableEntity>())
    {
          ...
          || entry.HasChangedOwnedEntities())
      {
        ...
        {
          if (ownedEntry.TargetEntry is { Entity: IAuditableEntity ownedEntity }
