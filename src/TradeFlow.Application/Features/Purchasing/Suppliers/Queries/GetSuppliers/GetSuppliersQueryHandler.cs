...
{
  public async Task<PaginatedList<SupplierDto>> Handle(GetSuppliersQuery request, CancellationToken ct)
  {
    ...
    return await PaginatedList<SupplierDto>.CreateAsync(projected, request.PageNumber, request.PageSize, ct);
  }
}
